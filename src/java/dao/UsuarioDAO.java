...
public class UsuarioDAO implements DAO<Usuario> {
    ...
    private static final String QUERY_BUSCAR = "SELECT id_usuario, nome_usuario, cpf_usuario, email_usuario, telefone_usuario, senha_usuario FROM tb_usuario WHERE id_usuario = ?";
    private static final String QUERY_BUSCAR_CPF = "SELECT id_usuario, nome_usuario, cpf_usuario, email_usuario, telefone_usuario, senha_usuario FROM tb_usuario FROM tb_usuario WHERE cpf_usuario = ?";
    private static final String QUERY_BUSCAR_EMAIL = "SELECT id_usuario, nome_usuario, cpf_usuario, email_usuario, telefone_usuario, senha_usuario FROM tb_usuario WHERE email_usuario = ?";
    ...
    public Usuario buscarEmail(String email) throws DAOException {
        Usuario usuario = null;
