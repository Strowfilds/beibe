...
public class FuncionarioDAO implements DAO<Usuario> {
    ...
    private static final String QUERY_BUSCAR_TODOS = "SELECT id_usuario, nome_usuario, cpf_usuario, email_usuario, telefone_usuario, senha_usuario, id_tipo_usuario FROM tb_usuario WHERE id_tipo_usuario_usuario = 2";
