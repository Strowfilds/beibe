 ...
 * @author ana
 */
@WebServlet(name = "RelatorioProdutoReclamadoServlet", urlPatterns = {"/RelatorioProdutoReclamadoServlet"})
public class RelatorioProdutoReclamadoServlet extends HttpServlet {
...
protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
        ...
        Logger.getLogger(RelatorioProdutoReclamadoServlet.class.getName()).log(Level.SEVERE, null, ex);
    }
    }
